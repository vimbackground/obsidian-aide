...
> {
  ...
  async generateResponse(
    ...
    if (!COMPATIBLE_PROVIDER_TYPES.includes(model.providerType as string)) {
      throw new Error(`Model providerType "${model.providerType}" is not an OpenAI Compatible model`)
    }
