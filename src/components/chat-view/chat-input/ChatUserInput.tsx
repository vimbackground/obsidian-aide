...
const ChatUserInput = forwardRef<ChatUserInputRef, ChatUserInputProps>(
  (
    ...
    return (
      <div className="aide-chat-user-input-container" ref={containerRef}>
        <div className="aide-chat-user-input-files">
          <ToolBadge />
          {mentionables.map((m) => (
            <MentionableBadge
        ...
        <div className="aide-chat-user-input-controls">
          <div
            className="aide-chat-user-input-controls__model-select-container"
...
function MentionableContentPreview({
  ...
  return displayFileContent ? (
    <div className="aide-chat-user-input-file-content-preview">
