...
export default function QueryProgress({
  ...
  switch (state.type) {
    ...
    case 'reading-mentionables':
      return (
        <div className="aide-query-progress">
          <p>
    ...
    case 'indexing':
      return (
        <div className="aide-query-progress">
          ...
          <p className="aide-query-progress-detail">{`${state.indexProgress.completedChunks}/${state.indexProgress.totalChunks} chunks indexed`}</p>
          {state.indexProgress.waitingForRateLimit && (
            <p className="aide-query-progress-detail">
