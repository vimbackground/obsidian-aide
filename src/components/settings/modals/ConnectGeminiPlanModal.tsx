...
function ConnectGeminiPlanModalComponent({
  ...
  return (
    <div>
      <div className="aide-plan-connect-steps">
        <div className="aide-plan-connect-steps-title">How it works</div>
        <ol>
      ...
      >
        ...
        {isWaitingForCallback && (
          <div className="aide-plan-connect-waiting">
            <div className="aide-plan-connect-waiting-content">
              <div className="aide-plan-connect-waiting-spinner" />
              <div className="aide-plan-connect-waiting-text">
      ...
      <ObsidianSetting
        ...
        className="aide-plan-connect-fallback"
      >
        <div className="aide-plan-connect-fallback-controls">
          {autoError && (
            <div className="aide-plan-connect-error">{autoError}</div>
          )}
          <ObsidianTextInput
            value={redirectUrl}
          ...
          />
          {manualError && (
            <div className="aide-plan-connect-error">{manualError}</div>
          )}
        </div>
      </ObsidianSetting>
