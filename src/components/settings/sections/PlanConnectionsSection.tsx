...
export function PlanConnectionsSection({
  ...
  return (
    <div className="aide-settings-section">
      <div className="aide-settings-header">Connect your subscription</div>

      <div className="aide-settings-desc">
        <div className="aide-settings-desc-warning">
          <strong className="aide-settings-desc-warning-title">
            Warning:
          </strong>{' '}
      ...
      <div className="aide-plan-connection-grid">
        <div className="aide-plan-connection-card">
          <div className="aide-plan-connection-card-header">
            <div className="aide-plan-connection-card-title">Claude</div>
            <PlanConnectionStatusBadge connected={isClaudeConnected} />
          </div>

          <div className="aide-plan-connection-card-desc">
            Uses your Claude Code usage from your Claude plan.
            <br />
            Check your limit in Claude Code with <code>/usage</code>.
          </div>

          <div className="aide-plan-connection-card-actions">
            {!isClaudeConnected && (
              <button
                className="mod-cta"
        ...
        <div className="aide-plan-connection-card">
          <div className="aide-plan-connection-card-header">
            <div className="aide-plan-connection-card-title">OpenAI</div>
        ...
        <div className="aide-plan-connection-card">
          <div className="aide-plan-connection-card-header">
            <div className="aide-plan-connection-card-title">Gemini</div>
...
function PlanConnectionStatusBadge({ connected }: { connected: boolean }) {
  const statusConfig = connected
    ? {
        icon: <Check size={16} />,
        label: 'Connected',
        statusClass: 'aide-mcp-server-status-badge--connected',
      }
    : {
        icon: <CircleMinus size={14} />,
        label: 'Disconnected',
        statusClass: 'aide-mcp-server-status-badge--disconnected',
      }

  return (
    <div
      className={`aide-mcp-server-status-badge ${statusConfig.statusClass}`}
    >
      {statusConfig.icon}
      <div className="aide-mcp-server-status-badge-label">
        {statusConfig.label}
      </div>
    </div>
  )
