      ...
      <div className="view-header">
        <div className="view-header-title-container mod-at-start">
          ...
          <div className="view-actions">
            <div className="aide-diff-navigation">
              <button
          ...
          <div className="cm-editor">
            <div className="cm-scroller" ref={scrollerRef}>
              <div className="cm-sizer">
                <div className="aide-inline-title">
                  {state?.file?.name
...
>(({ block: part, onAcceptIncoming, onAcceptCurrent, onAcceptBoth }, ref) => {
  if (part.type === 'unchanged') {
    return (
      <div className="aide-diff-block">
        <div style={{ width: '100%' }}>{part.value}</div>
      </div>
    )
  } else if (part.type === 'modified') {
    return (
      <div className="aide-diff-block-container" ref={ref}>
        {part.originalValue && part.originalValue.length > 0 && (
          <div className="aide-diff-block removed">
            <div style={{ width: '100%' }}>{part.originalValue}</div>
          </div>
        )}
        {part.modifiedValue && part.modifiedValue.length > 0 && (
          <div className="aide-diff-block added">
            <div style={{ width: '100%' }}>{part.modifiedValue}</div>
          </div>
        )}
        <div className="aide-diff-block-actions">
          <button onClick={onAcceptIncoming} className="aide-accept">
            Accept Incoming
          </button>
          <button onClick={onAcceptCurrent} className="aide-exclude">
            Accept Current
          </button>
